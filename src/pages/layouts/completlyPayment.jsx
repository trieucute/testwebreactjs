                          ...
                          <div className="infor__trip mt-4 ">
                            <div className="card ">
                              ...
                              <div className="row mt-3">
                                ...
                                <div className="col text-end ">
                                  <span> { TimeHM(val.trip.schedule.find(item => item.type === 'pickup').time)} {val.trip.departure_time.split(' ')[0]}</span>
                                </div>
                              </div>
                              <div className="row mt-3">
                              ...
                              <div className="row mt-3">
                                ...
                                <div className="col text-end ">
                                {val.pickup_location} ({val.trip.start_station.address})
                                </div>
                              </div>
                              <div className="row mt-3">
